...
def create_new_game_data():
    return {
        ...
        'end_time': None,
        'duration': None,
        'gameType': 'DefconExpanded | 16 Player | Test Server'
    }

def process_game_logs(game_events_file, output_directory):
    print(f"Starting game log processor for 16 Player Server")
...
def get_territory_name(territory_id):
    territories = {
        ...
        13: "Antartica",
        14: "India",
        15: "North Eastern Africa"
    }
    return territories.get(territory_id, "Unknown")

if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python game_log_processor4v4.py <game_events_file> <output_directory>")
        sys.exit(1)
