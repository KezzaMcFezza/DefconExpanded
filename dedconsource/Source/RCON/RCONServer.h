 ...
 *  */
 ...
 extern SecretStringSetting rconPassword;                                       // password
 extern IntegerSetting rconTimeoutWindow;                                       // client timeout in seconds (default: 300, 0=disabled)
 extern IntegerSetting rconEncryption;                                          // enable/disable encryption (0=disabled, 1=enabled)
