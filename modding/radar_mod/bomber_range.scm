...
(define (defcon-bomber-range inImage inLayer)
  (let* ((theImage inImage)
    ...
    ; Blur to bomber range: 71 pixels total
    ...
    (gimp-item-set-name workLayer "Bomber Range")
...
(script-fu-register "defcon-bomber-range"
                   "Bomber Range..."
                   "Creates bomber range layer (71px)"
                   "Manuel Moos"
                   "Manuel Moos"
                   "May 2007"
                   "*"
...
(script-fu-menu-register "defcon-bomber-range" 
