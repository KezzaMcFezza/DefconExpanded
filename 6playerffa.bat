...
start "Game Log Processor for FFA Server" cmd /k python game_log_processor6playerffa.py "game_events_6playerffa.log" "game_logs"

:server_loop
set "game_start_time=%date:~10,4%-%date:~4,2%-%date:~7,2%T%time:~0,2%-%time:~3,2%-%time:~6,2%"
set "game_start_time=!game_start_time: =0!"

echo Starting Dedcon server for FFA...
dedcon.exe 6playerffaconfig.txt 
