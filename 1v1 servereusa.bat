...
start "Game Log Processor 1v1 EU vs SA" cmd /k python game_log_processor1v1eusa.py "game_events_1v1eusa.log" "game_logs"

:server_loop
set "game_start_time=%date:~10,4%-%date:~4,2%-%date:~7,2%T%time:~0,2%-%time:~3,2%-%time:~6,2%"
set "game_start_time=!game_start_time: =0!"

echo Starting Dedcon server for 1v1 EU vs SA...
dedcon.exe 1v1configeusa.txt 
