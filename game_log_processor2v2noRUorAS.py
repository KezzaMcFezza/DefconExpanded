...
def create_new_game_data():
    return {
        ...
        'end_time': None,
        'duration': None,
        'gameType': 'DefconExpanded | 2v2 | NA-SA-EU-AF | Totally Random',
        'last_alliance': None
    }

def process_game_logs(game_events_file, output_directory):
    print(f"Starting game log processor for 2V2 EU AF NA SA player server")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python game_log_processor2v2noRUorAS.py <game_events_file> <output_directory>")
        sys.exit(1)
