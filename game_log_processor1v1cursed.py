...
def create_new_game_data():
    return {
        ...
        'end_time': None,
        'duration': None,
        'gameType': 'DefconExpanded | 1v1 | Cursed Setups Only!'
    }

def process_game_logs(game_events_file, output_directory):
    print(f"Starting game log processor for 1v1 cursed setups server")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python game_log_processor1v1cursed.py <game_events_file> <output_directory>")
        sys.exit(1)
