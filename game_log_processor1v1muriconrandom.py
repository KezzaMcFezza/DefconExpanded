...
def create_new_game_data():
    return {
        ...
        'end_time': None,
        'duration': None,
        'gameType': 'MURICON | 1V1 | Totally Random | 2.8.15'
    }

def process_game_logs(game_events_file, output_directory):
    print(f"Starting game log processor for 1v1 muricon random")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python game_log_processorhawhaw1v1.py <game_events_file> <output_directory>")
        sys.exit(1)
