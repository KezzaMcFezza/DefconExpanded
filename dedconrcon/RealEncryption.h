...
#ifndef REAL_ENCRYPTION_H
#define REAL_ENCRYPTION_H
...
// use the same packet structure as client
struct ServerEncryptedPacket
{
...
extern std::unique_ptr<RealEncryption> g_serverEncryption;
bool initServerEncryption                                                       (const std::string &password);

#endif // REAL_ENCRYPTION_H