...
DropDownWindow::DropDownWindow( const char *_name, const char *_title, bool _titleIsLanguagePhrase, const char *_parentName )
...
DropDownWindow *DropDownWindow::CreateDropDownWindow( const char *_name, const char *_title, bool _titleIsLanguagePhrase, const char *_parentName )
{
    if( s_window )
    {
...
void DropDownMenu::SetProperties( const char *_name, int _x, int _y, int _w, int _h,
