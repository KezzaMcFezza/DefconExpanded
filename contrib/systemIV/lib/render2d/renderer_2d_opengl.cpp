...
void Renderer2DOpenGL::CleanupBuffers()
{
	...
	if ( m_rotatingSpriteVAO )
		glDeleteVertexArrays( 1, &m_rotatingSpriteVAO );
	if ( m_rotatingSpriteVBO )
		glDeleteBuffers( 1, &m_rotatingSpriteVBO );
	if ( m_lineVAO )
	...
	if ( m_circleFillVAO )
		glDeleteVertexArrays( 1, &m_circleFillVAO );
	if ( m_circleFillVBO )
		glDeleteBuffers( 1, &m_circleFillVBO );
	if ( m_rectVAO )
		glDeleteVertexArrays( 1, &m_rectVAO );
	if ( m_rectVBO )
		glDeleteBuffers( 1, &m_rectVBO );
	if ( m_rectFillVAO )
		glDeleteVertexArrays( 1, &m_rectFillVAO );
	if ( m_rectFillVBO )
		glDeleteBuffers( 1, &m_rectFillVBO );
	if ( m_triangleFillVAO )
