...
void RendererOpenGL::SetTextureParameter(unsigned int pname, int param) 
{
    ...
    if ((pname == TEXTURE_MAG_FILTER || pname == GL_TEXTURE_MAG_FILTER || 
        ...
        switch (param) 
        {
            case TEXTURE_FILTER_NEAREST: glParam = GL_NEAREST; break;
            case TEXTURE_FILTER_LINEAR: glParam = GL_LINEAR; break;
            case TEXTURE_FILTER_NEAREST_MIPMAP_NEAREST: glParam = GL_NEAREST_MIPMAP_NEAREST; break;
            case TEXTURE_FILTER_LINEAR_MIPMAP_NEAREST: glParam = GL_LINEAR_MIPMAP_NEAREST; break;
            case TEXTURE_FILTER_NEAREST_MIPMAP_LINEAR: glParam = GL_NEAREST_MIPMAP_LINEAR; break;
            case TEXTURE_FILTER_LINEAR_MIPMAP_LINEAR: glParam = GL_LINEAR_MIPMAP_LINEAR; break;
            default: glParam = param;
        }
    }
...
void RendererOpenGL::SetBlendFunc(int srcFactor, int dstFactor) 
{
    ...
    switch (srcFactor) 
    {
        case BLEND_ZERO: glSrcFactor = GL_ZERO; break;
        case BLEND_ONE: glSrcFactor = GL_ONE; break;
        case BLEND_SRC_ALPHA: glSrcFactor = GL_SRC_ALPHA; break;
        case BLEND_ONE_MINUS_SRC_ALPHA: glSrcFactor = GL_ONE_MINUS_SRC_ALPHA; break;
        case BLEND_ONE_MINUS_SRC_COLOR: glSrcFactor = GL_ONE_MINUS_SRC_COLOR; break;
        default: 
    ...
    switch (dstFactor) 
    {
        case BLEND_ZERO: glDstFactor = GL_ZERO; break;
        case BLEND_ONE: glDstFactor = GL_ONE; break;
        case BLEND_SRC_ALPHA: glDstFactor = GL_SRC_ALPHA; break;
        case BLEND_ONE_MINUS_SRC_ALPHA: glDstFactor = GL_ONE_MINUS_SRC_ALPHA; break;
        case BLEND_ONE_MINUS_SRC_COLOR: glDstFactor = GL_ONE_MINUS_SRC_COLOR; break;
        default:
...
{
    GLenum glMode = (mode == CULL_FACE_BACK) ? GL_BACK :
                    (mode == CULL_FACE_FRONT) ? GL_FRONT :
                    GL_FRONT_AND_BACK;
