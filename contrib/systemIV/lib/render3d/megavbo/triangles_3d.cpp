...
{
	if ( !m_megaVBO3DTrianglesActive || vertexCount < 3 )
		return;
...
void MegaVBO3D::AddTrianglesToMegaVBO3DWithIndices( const Vector3<float> *vertices,
													...
													int indexCount )
{
	if ( !m_megaVBO3DTrianglesActive || vertexCount < 3 || indexCount < 3 )
		return;
...
{
	if ( !m_megaVBO3DTrianglesActive || !m_currentMegaVBO3DTrianglesKey )
		return;
