...
void Renderer3DOpenGL::CleanupBuffers3D()
{
	...
	if ( m_spriteVBO3D )
		glDeleteBuffers( 1, &m_spriteVBO3D );
	if ( m_lineVAO3D )
		glDeleteVertexArrays( 1, &m_lineVAO3D );
	if ( m_lineVBO3D )
		glDeleteBuffers( 1, &m_lineVBO3D );
	if ( m_textVAO3D )
		glDeleteVertexArrays( 1, &m_textVAO3D );
	if ( m_textVBO3D )
		glDeleteBuffers( 1, &m_textVBO3D );
	if ( m_circleVAO3D )
		glDeleteVertexArrays( 1, &m_circleVAO3D );
	if ( m_circleVBO3D )
		glDeleteBuffers( 1, &m_circleVBO3D );
	if ( m_circleFillVAO3D )
		glDeleteVertexArrays( 1, &m_circleFillVAO3D );
	if ( m_circleFillVBO3D )
		glDeleteBuffers( 1, &m_circleFillVBO3D );
	if ( m_rectVAO3D )
		glDeleteVertexArrays( 1, &m_rectVAO3D );
	if ( m_rectVBO3D )
		glDeleteBuffers( 1, &m_rectVBO3D );
	if ( m_rectFillVAO3D )
		glDeleteVertexArrays( 1, &m_rectFillVAO3D );
	if ( m_rectFillVBO3D )
		glDeleteBuffers( 1, &m_rectFillVBO3D );
	if ( m_triangleFillVAO3D )
