...
public:
    DropDownWindow( const char *_name, const char *_title, bool _titleIsLanguagePhrase, const char *_parentName );
    ~DropDownWindow();
    void Update();

    // There can be only one
    static DropDownWindow *CreateDropDownWindow( const char *_name, const  char *_title, bool _titleIsLanguagePhrase, const char *_parentName );
...
public:
    ...
    void            SetProperties       ( const char *_name, int _x, int _y, int _w, int _h,
