...
void LanguageTable::LoadCurrentLanguage( const char *_name )
{
	ClearBaseLanguage();
	ClearTranslation();
...
bool LanguageTable::LanguageTableIsNewLanguagePhraseError( const char *_file, int _line, char flag, char *subject, int nbFound )
{
	bool newError = false;
...
int LanguageTable::DebugReplaceStringFlag( const char *_file, int _line, char flag, const char *string, char *subject )
{
...
int LanguageTable::DebugReplaceIntegerFlag( const char *_file, int _line, char flag, int num, char *subject )
{
