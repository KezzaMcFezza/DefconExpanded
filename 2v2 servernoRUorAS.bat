...
start "Game Log Processor 2v2 EU AF NA SA" cmd /k python game_log_processor2v2noRUorAS.py "game_events_2v2noRUorAS.log" "game_logs"
...
dedcon.exe 2v2confignoRUorAS.txt 
