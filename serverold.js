...
// the deed
process.env.DB_PASSWORD ? console.log("Hell yea") : console.log("We're screwed");
...
// logs the ip from the user who uses the admin panel, no fuckery is happening on my website
...
// api for checking if a user is logged in.
...
// api that allows the admins to access the dedcon config files
