...
start "Game Log Processor 1v1 Cursed Setups" cmd /k python game_log_processor1v1cursed.py "game_events_1v1cursed.log" "game_logs"
...
dedcon.exe 1v1configcursed.txt 
