...
void MapRenderer::RenderSanta()
{
	...
	{
        //g_renderer->Circle( g_app->m_world->m_santaLongitude.DoubleValue(), g_app->m_world->m_santaLatitude.DoubleValue(), 3, 30, White, 1 );
		...
		if ( g_app->GetWorld()->m_santaCurrent % 2 == 0 )
		{
			...
			//g_renderer->Circle( x, y, 3, 40, White, 4.0f );
