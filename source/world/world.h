...
public:
    ...
    DArray <Fixed>		m_santaRouteLength;
	Fixed				m_santaRouteTotal;
	int					m_santaCurrent;
	bool				m_santaAlive;

	Fixed				m_santaLongitude;
	Fixed				m_santaLatitude;
	bool				m_santaPrevFlipped;
#endif
...
public:   
    ...
    const char  *GetAllianceName      ( int _allianceId );
    ...
    void AddWorldMessage        ( Fixed longitude, Fixed latitude, int teamId, const char *msg, int msgType, bool showOnToolbar=true );
    void AddWorldMessage        ( int objectId, int teamId, const char *msg, int msgType, bool showOnToolbar=true );
    void AddDestroyedMessage    ( int attackerId, int defenderId, bool explosion = false );
    void AddOutOfFueldMessage   ( int objectId );

    void AddChatMessage         ( int teamId, int channel, const char *_msg, int msgId, bool spectator );
