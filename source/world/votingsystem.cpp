    ...
    if( m_result == VoteYes )
    {
        ...
        switch( m_voteType )
        {
            case VoteTypeJoinAlliance:
            {
                ...
                strcpy( msg, LANGUAGEPHRASE("message_alliance_join") );
            ...
            case VoteTypeKickPlayer:
            {
                ...
                strcpy( msg, LANGUAGEPHRASE("message_alliance_kicked") );
                LPREPLACESTRINGFLAG('P', team->GetTeamName(), msg);

                const char *allianceName = g_app->GetWorld()->GetAllianceName(team->m_allianceId);
            ...
            case VoteTypeLeaveAlliance:
            {
                ...
                strcpy( msg, LANGUAGEPHRASE("message_alliance_leave") );
                LPREPLACESTRINGFLAG('P', team->GetTeamName(), msg);
