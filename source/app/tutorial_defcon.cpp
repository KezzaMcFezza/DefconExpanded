...
{
    char msg[256];
    strcpy(msg, LANGUAGEPHRASE("tutorial_missioncomplete"));
...
{
    char msg[256];
    strcpy(msg, LANGUAGEPHRASE("tutorial_missionfailed"));
    g_app->GetInterface()->ShowMessage(0, 0, -1, msg, true );
}
...
void TutorialPopup::SetMessage( const char *_name, const char *_stringId )
{
...
void TutorialPopup::SetUITarget( const char *_window, const char *_button )
{
...
void TutorialPopup::Render( bool _hasFocus )
{
    ...
    if( renderCaptions )
    {
        ...
        {
            const char *string = LANGUAGEPHRASE(m_stringId);
