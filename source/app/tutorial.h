...
public:
    ...
    const char    *GetCurrentObjective    ();
...
public:
    ...
    void    GenerateUniqueName  ( const char *_name );

    void    SetMessage          ( const char *_name, const char *_stringId );
    ...
    void    SetUITarget         ( const char *_window, const char *_button );
