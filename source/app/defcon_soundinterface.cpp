...
bool DefconSoundInterface::GetPropertyRange( const char *_property, float *_min, float *_max )
{
    *_min = 0;
    *_max = 0;
...
float DefconSoundInterface::GetPropertyValue( const char *_property, SoundObjectId _id )
{    
