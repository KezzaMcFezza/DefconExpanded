...
const char *Tutorial::GetCurrentMessage()
{
    if( m_chapters.ValidIndex(m_currentChapter) )
    {
        TutorialChapter *chapter = m_chapters[m_currentChapter];
        const char *phrase = LANGUAGEPHRASE( chapter->m_message );
        return phrase;
    }
...
const char *Tutorial::GetCurrentObjective()
{
    if( m_chapters.ValidIndex(m_currentChapter) )
    {
        TutorialChapter *chapter = m_chapters[m_currentChapter];
        const char *phrase = LANGUAGEPHRASE( chapter->m_objective );
        return phrase;
    }
...
const char *Tutorial::GetCurrentLevelName()
{
