...
public:
    ...
    void SendChatMessage        ( unsigned char teamId, unsigned char channel, const char *msg, int messageId, bool spectator=false );
    void SendChatMessageReliably( unsigned char teamId, unsigned char channel, const char *msg, bool spectator );
