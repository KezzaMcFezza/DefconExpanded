    ...
    if( g_app->GetServer() )
    {
        ...
        for( int i = 0; i < maxClients; ++i )
        {
            if( g_app->GetServer()->m_clients.ValidIndex(i) )
            {
                ...
                {
                    col.Set( 255, 0, 0, 255 );
                    strcpy( caption, LANGUAGEPHRASE("dialog_network_lost_con") );
                ...
                else if( !sToc->m_caughtUp ) 
                {
                    ...
                    strcpy( caption, LANGUAGEPHRASE("dialog_network_synching") );
                ...
                else
                {
                    ...
                    strcpy( caption, LANGUAGEPHRASE("dialog_network_ping") );
