...
void Interface::Render()
{
    ...
    if( !connectionScrewed )
    {
            ...
            !m_message )
        {
            ...
            char msg[256];
            strcpy( msg, LANGUAGEPHRASE("dialog_defcon_x_in_x_time") );
        ...
        if( victoryTimer > 0.0f )
        {
            ...
            char caption[256];
            strcpy( caption, LANGUAGEPHRASE("dialog_time_remaining") );
...
void Interface::RenderMouse()
{
    if( g_app->MousePointerIsVisible() )
    {
        ...
        g_renderer->SetBlendMode( Renderer::BlendModeNormal );
        g_renderer2d->StaticSprite( mouse, mouseX-8, mouseY-8, White, true );
    }
}


void Interface::ShowMessage( Fixed longitude, Fixed latitude, int teamId, const char *msg, bool showLarge )
{
