...
start "Game Log Processor DefconExpanded 3v3 Totally Random" cmd /k python python_parsers/LogProcessorVanilla.py "dedcon_game_events/game_events_DefconExpanded_3v3_Totally_Random.log" "game_logs"

:server_loop
set "game_start_time=%date:~10,4%-%date:~4,2%-%date:~7,2%T%time:~0,2%-%time:~3,2%-%time:~6,2%"
set "game_start_time=!game_start_time: =0!"

echo Starting Dedcon server for DefconExpanded 3v3 Totally Random...
Dedcon.exe "dedcon_configs/DefconExpanded 3v3 Totally Random.txt" 
