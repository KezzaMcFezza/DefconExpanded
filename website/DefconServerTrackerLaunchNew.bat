...
start "Defcon Status Bot" cmd /k python DefconServerTrackerNew.py ^
game_events_1v1.log:"1v1 Random" server_output_1v1.log ^
game_events_1v1variable.log:"1v1 Lots of Units" server_output_1v1variable.log ^
...
game_events_1v1ukbalanced.log:"1v1 UK and Ireland" server_output_1v1ukbalanced.log ^
game_events_2v2ukbalanced.log:"2v2 UK and Ireland" server_output_2v2ukbalanced.log ^
game_events_diplouk.log:"Diplomacy UK and Ireland" server_output_diplouk.log ^
...
game_events_muriconuk.log:"Muricon UK Mod" server_output_muriconuk.log ^
