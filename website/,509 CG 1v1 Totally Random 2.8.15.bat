...
start "Game Log Processor 509 CG 1v1 Totally Random 2.8.15" cmd /k python python_parsers/LogProcessorEightPlayer.py "dedcon_game_events/game_events_509_CG_1v1_Totally_Random_2.8.15.log" "game_logs"

:server_loop
set "game_start_time=%date:~10,4%-%date:~4,2%-%date:~7,2%T%time:~0,2%-%time:~3,2%-%time:~6,2%"
set "game_start_time=!game_start_time: =0!"

echo Starting Dedcon server for 509 CG 1v1 Totally Random 2.8.15...
Dedcon8P.exe "dedcon_configs/509 CG 1v1 Totally Random 2.8.15.txt" 
