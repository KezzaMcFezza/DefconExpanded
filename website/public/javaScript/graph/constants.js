...
export const GRAPH_CONFIGS = {
    individualServers: {
        serverTypes: [
            ...
            { key: "defcon_training", name: "DefconExpanded Training", color: "#7dd87d" },
            { key: "defcon_test", name: "DefconExpanded Test", color: "#c0c0c0" },
            ...
            { key: "defcon_2v2_uk", name: "2v2 UK and Ireland", color: "#5f9ea0" },
            { key: "tournament_2v2", name: "2v2 Tournament", color: "#c71585" },
            { key: "defcon_2v2_max_cities", name: "2v2 Max Cities", color: "#8a2be2" },
            ...
            { key: "muricon_uk", name: "MURICON UK Mod", color: "#b8860b" },
            { key: "defcon_diplo_uk", name: "Diplomacy UK and Ireland", color: "#6495ed" },
            ...
            { key: "defcon_5v5_ffa", name: "5v5 Random", color: "#2e8b57" },
            { key: "defcon_10p_diplo", name: "10P Diplomacy", color: "#8b008b" },
            { key: "defcon_16p", name: "16 Player Test", color: "#778899" }
        ],
