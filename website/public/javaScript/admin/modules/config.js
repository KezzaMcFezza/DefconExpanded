...
const ConfigModule = (() => {
    ...
    const serverConfigs = [
        ...
        { name: "DefconExpanded | 2v2 | Max Cities - Pop", filename: "DefconExpanded 2v2 Max Cities - Pop.txt", permission: PERMISSIONS.CONFIG_2V2_DEFAULT },
        ...
        { name: "509 CG | 1v1 | Totally Random | 2.8.15", filename: "509 CG 1v1 Totally Random 2.8.15.txt", permission: PERMISSIONS.CONFIG_1V1_RANDOM },
        ...
        { name: "DefconExpanded | Training Server", filename: "DefconExpanded Training.txt", permission: PERMISSIONS.CONFIG_1V1_TEST },
