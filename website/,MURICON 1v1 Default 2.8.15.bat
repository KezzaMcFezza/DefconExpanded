...
start "Game Log Processor MURICON 1v1 Default 2.8.15" cmd /k python python_parsers/LogProcessorEightPlayer.py "dedcon_game_events/game_events_MURICON_1v1_Default_2_8_15.log" "game_logs"

:server_loop
set "game_start_time=%date:~10,4%-%date:~4,2%-%date:~7,2%T%time:~0,2%-%time:~3,2%-%time:~6,2%"
set "game_start_time=!game_start_time: =0!"

echo Starting Dedcon server for MURICON 1v1 Default 2.8.15...
Dedcon8P.exe "dedcon_configs/MURICON 1v1 Default 2.8.15.txt" 
