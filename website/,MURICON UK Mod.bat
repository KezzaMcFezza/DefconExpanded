...
start "Game Log Processor MURICON UK Mod" cmd /k python python_parsers/LogProcessorUKDiplo.py "dedcon_game_events/game_events_MURICON_UK_Mod.log" "game_logs"

:server_loop
set "game_start_time=%date:~10,4%-%date:~4,2%-%date:~7,2%T%time:~0,2%-%time:~3,2%-%time:~6,2%"
set "game_start_time=!game_start_time: =0!"

echo Starting Dedcon server for MURICON UK Mod...
Dedcon.exe "dedcon_configs/MURICON UK Mod.txt" 
