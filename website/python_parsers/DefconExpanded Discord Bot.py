...
SERVER_NAME_MAPPING = {
    "DEFCONEXPANDED_1V1_TOTALLY_RANDOM": "1v1 Random",
    "DEFCONEXPANDED_1V1_TOTALLY_RANDOM_SECOND_SERVER": "1v1 Random Second",
    "DEFCONEXPANDED_1V1_LOTS_OF_UNITS": "1v1 Lots of Units",
    "DEFCONEXPANDED_1V1_BEST_SETUPS_ONLY": "1v1 Best Setups",
    "DEFCONEXPANDED_1V1_QUICK_MATCH": "1v1 Quick Match",
    "DEFCONEXPANDED_1V1_CURSED_SETUPS_ONLY": "1v1 Cursed Setups",
    "RAIZERS_RUSSIA_VS_USA_TOTALLY_RANDOM": "1v1 Raizer's Server",
    "DEFCONEXPANDED_1V1_BEST_SETUPS_ONLY_SECOND_SERVER": "1v1 Best Setups",
    "DEFCONEXPANDED_1V1_DEFAULT": "1v1 Default",
    "DEFCONEXPANDED_1V1_UK_AND_IRELAND": "1v1 UK and Ireland",
    "DEFCONEXPANDED_2V2_UK_AND_IRELAND": "2v2 UK and Ireland",
    "DEFCONEXPANDED_DIPLOMACY_UK_AND_IRELAND": "Diplomacy UK and Ireland",
    "MURICON_UK_MOD": "Muricon UK Mod",
    "NEW_PLAYERS_WELCOME_COME_AND_PLAY": "New Player Server",
    "DEFCONEXPANDED_TRAINING": "Training Server",
    "DEFCONEXPANDED_1V1_CHRISTMAS_TOURNAMENT": "1v1 Christmas Tournament",
    "DEFCONEXPANDED_1V1_CHRISTMAS_TOURNAMENT_SECOND_SERVER": "1v1 Christmas Tournament Second",
    "DEFCONEXPANDED_2V2_TOURNAMENT": "2v2 Tournament",
    "DEFCONEXPANDED_2V2_TOTALLY_RANDOM": "2v2 Random",
    "DEFCONEXPANDED_2V2_TOTALLY_RANDOM_SECOND_SERVER": "2v2 Random Second",
    "DEFCONEXPANDED_2V2_MAX_CITIES_POP": "2v2 Max Cities / Pop",
    "DEFCONEXPANDED_FREE_FOR_ALL_RANDOM_CITIES": "FFA Server",
    "DEFCONEXPANDED_3V3_TOTALLY_RANDOM": "3v3 Random",
    "DEFCONEXPANDED_3V3_TOTALLY_RANDOM_SECOND_SERVER": "3v3 Random Second",
    "MURICON_1V1_TOTALLY_RANDOM_2_8_15": "Muricon 1v1 Random",
    "509_CG_2V2_TOTALLY_RANDOM_2_8_15": "509 CG 2v2",
    "MURICON_1V1_DEFAULT_2_8_15": "Muricon 1v1",
    "DEFCONEXPANDED_4V4_TOTALLY_RANDOM": "4v4 Random",
    "DEFCONEXPANDED_8_PLAYER_DIPLOMACY": "8 Player Diplo",
    "DEFCONEXPANDED_5V5_TOTALLY_RANDOM": "5v5 Random",
    "DEFCONEXPANDED_10_PLAYER_DIPLOMACY": "10 Player Diplo",
    "DEFCONEXPANDED_16_PLAYER_TEST_SERVER": "16 Player Server",
    "SONY_AND_HOOVS_HIDEOUT": "Sony and Hoovs Hideout",
    "DEFCONEXPANDED_TEST_SERVER": "Test Server",
    "DEFCONEXPANDED_1V1_AF_VS_AS": "1v1 AF vs AS"
}
...
async def monitor_server_output(output_file, bot):
    ...
    # Extract the internal name from the full path
    filename = os.path.basename(output_file)  # Get just the filename
    internal_name = filename.replace('server_output_', '').replace('.log', '').upper()
