...
start "Game Log Processor DefconExpanded 4v4 Totally Random" cmd /k python python_parsers/LogProcessorEightPlayer.py "dedcon_game_events/game_events_DefconExpanded_4v4_Totally_Random.log" "game_logs"

:server_loop
set "game_start_time=%date:~10,4%-%date:~4,2%-%date:~7,2%T%time:~0,2%-%time:~3,2%-%time:~6,2%"
set "game_start_time=!game_start_time: =0!"

echo Starting Dedcon server for DefconExpanded 4v4 Totally Random...
Dedcon8P.exe "dedcon_configs/DefconExpanded 4v4 Totally Random.txt" 
