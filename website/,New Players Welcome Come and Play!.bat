...
start "Game Log Processor New Players Welcome Come and Play!" cmd /k python python_parsers/LogProcessorVanilla.py "dedcon_game_events/game_events_New_Players_Welcome_Come_and_Play.log" "game_logs"

:server_loop
set "game_start_time=%date:~10,4%-%date:~4,2%-%date:~7,2%T%time:~0,2%-%time:~3,2%-%time:~6,2%"
set "game_start_time=!game_start_time: =0!"

echo Starting Dedcon server for New Players Welcome Come and Play!...
Dedcon.exe "dedcon_configs/New Players Welcome Come and Play!.txt" 
