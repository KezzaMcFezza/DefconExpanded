...
const serverConfigurations = [
    ...
    { name: 'DefconExpanded | 1v1 | Totally Random - Second Server', port: 8808, permission: permissions.RCON_1V1_RANDOM_SECOND },
    { name: 'MURICON | 1v1 Default | 2.8.15', port: 8809, permission: permissions.RCON_MURICON_DEFAULT },
    { name: 'DefconExpanded | 2v2 | Totally Random', port: 8810, permission: permissions.RCON_2V2_RANDOM },
    { name: 'DefconExpanded | 2v2 | UK and Ireland', port: 8811, permission: permissions.RCON_2V2_UK_IRELAND },
    { name: 'DefconExpanded | 2v2 | Tournament', port: 8812, permission: permissions.RCON_2V2_TOURNAMENT },
    { name: 'DefconExpanded | 2v2 | Max Cities - Pop', port: 8813, permission: permissions.RCON_2V2_MAX_CITIES },
    { name: 'MURICON | 1V1 | Totally Random | 2.8.15', port: 8814, permission: permissions.RCON_MURICON_RANDOM },
    { name: '509 CG | 1v1 | Totally Random | 2.8.15', port: 8815, permission: permissions.RCON_509CG_1V1 },
    { name: '509 CG | 2v2 | Totally Random | 2.8.15', port: 8816, permission: permissions.RCON_509CG_2V2 },
    { name: 'Raizer\'s Russia vs USA | Totally Random', port: 8817, permission: permissions.RCON_RAIZER_RUSSIA_USA },
    { name: 'Sony and Hoov\'s Hideout', port: 8818, permission: permissions.RCON_SONY_HOOV },
    ...
    { name: 'DefconExpanded | Diplomacy | UK and Ireland', port: 8826, permission: permissions.RCON_DIPLOMACY_UK },
    { name: 'DefconExpanded | 4v4 | Totally Random', port: 8830, permission: permissions.RCON_4V4_RANDOM },
    { name: 'DefconExpanded | 5v5 | FFA | Totally Random', port: 8831, permission: permissions.RCON_5V5_FFA },
    { name: 'DefconExpanded | 8 Player | Diplomacy', port: 8832, permission: permissions.RCON_8PLAYER_DIPLOMACY },
    { name: 'DefconExpanded | 10 Player | Diplomacy', port: 8833, permission: permissions.RCON_10PLAYER_DIPLOMACY },
    { name: 'DefconExpanded | 16 Player | Test Server', port: 8834, permission: permissions.RCON_16PLAYER_TEST }
];
