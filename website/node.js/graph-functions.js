...
function processCombinedServersData(rows) {
    try {
        ...
        console.error('Error processing combined servers data:', error);
        return [];
    }
}
...
function processTotalHoursData(rows) {
    try {
        ...
        console.error('Error processing total hours data:', error);
        return [];
    }
}
...
function processTerritoriesData(rows) {
    try {
        ...
        console.error('Error processing territories data:', error);
        return [];
    }
}
...
function process1v1SetupData(rows, options = {}) {
    try {
        ...
        console.error('Error processing 1v1 setup data:', error);
        return [];
    }
}
...
function processIndividualServersData(rows) {
    try {
        ...
        console.error('Error processing individual servers data:', error);
        return [];
    }
}
