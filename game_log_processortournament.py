...
def create_new_game_data():
    return {
        ...
        'end_time': None,
        'duration': None,
        'gameType': '2v2 Tournament'
    }

def process_game_logs(game_events_file, output_directory):
    print(f"Starting game log processor for Tournament server...")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python game_log_processortournament.py <game_events_file> <output_directory>")
        sys.exit(1)
