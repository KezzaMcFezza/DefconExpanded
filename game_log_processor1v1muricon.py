...
def create_new_game_data():
    return {
        ...
        'end_time': None,
        'duration': None,
        'gameType': 'MURICON | 1v1 Default'
    }

def process_game_logs(game_events_file, output_directory):
    print(f"Starting game log processor for Muricon 1v1")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python game_log_processor1v1muricon.py <game_events_file> <output_directory>")
        sys.exit(1)
