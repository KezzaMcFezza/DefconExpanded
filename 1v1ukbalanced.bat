...
start "Game Log Processor 1v1 uk balanced" cmd /k python LogProcessorUKVanilla.py "game_events_1v1ukbalanced.log" "game_logs"
...
dedcon.exe 1v1configukbalanced.txt 
