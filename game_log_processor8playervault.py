...
def create_new_game_data():
    return {
        ...
        'end_time': None,
        'duration': None,
        'gameType': 'Vault Tecs | 2x Blitz | Random Cities',
        'last_alliance': None
    }

def process_game_logs(game_events_file, output_directory):
    print(f"Starting game log processor for 8 player vault server")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python game_log_processor8playervault.py <game_events_file> <output_directory>")
        sys.exit(1)
