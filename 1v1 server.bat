...
start "Game Log Processor 1v1" cmd /k python game_log_processor1v1.py "server_output_1v1.log" "game_events_1v1.log" "game_logs"
...
dedcon.exe ConfigFile3.txt endgame.txt
